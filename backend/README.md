...
## Project Structure
    ...
    ├── testapiautocatalog_106330  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_106330`
...
2. Clone this repo and `cd testapiautocatalog_106330`
